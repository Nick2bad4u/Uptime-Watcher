...
> **Navigation:** [📖 Docs Home](../README.md) » [📚 API Reference](README.md) » **Database API**
...
- [📋 Types API](types-api.md) - Site, monitor, and history type definitions
- [🏪 Store API](store-api.md) - State management and data flow
- [📊 Monitor API](monitor-api.md) - Monitoring service integration
- [🔔 Notification API](notification-api.md) - Status change notifications
- [📊 Chart API](chart-api.md) - History data visualization
- [🛠️ Utilities API](utilities-api.md) - Database helper utilities
