...
export function DynamicMonitorFields({ monitorType, values, onChange, isLoading }: DynamicMonitorFieldsProps) {
...
export function validateMonitorField(type: MonitorType, fieldName: string, value: any): string[] {
 const definition = MONITOR_TYPE_DEFINITIONS[type];
