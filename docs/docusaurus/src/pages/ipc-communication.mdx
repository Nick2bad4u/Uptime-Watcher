...
<Mermaid value={`classDiagram
    ...
    class SitesChannel {
        ...
        +handle("delete-site", payload)
        +handle("get-sites", payload)
        +handle("get-site", payload)
    }
    ...
    class MonitoringChannel {
        ...
        +handle("run-manual-check", payload)
    }

    class SettingsChannel {
        +handle("get-settings", payload)
        +handle("update-settings", payload)
...
<Mermaid value={`sequenceDiagram
    ...
    API->>Preload: ipcRenderer.invoke("add-site", siteData)
    Preload->>IPC: forward invoke
    ...
    Events->>Preload: webContents.send("site:added")
