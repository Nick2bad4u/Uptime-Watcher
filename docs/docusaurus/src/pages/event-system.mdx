...
This diagram shows the typed event system:
...
<Mermaid value={`classDiagram
    class UptimeEvents {
        ...
        +"site:updated": Site
        +"site:deleted": string
        +"monitor:status-changed": MonitorStatusEvent
        +"monitor:up": MonitorEvent
        +"monitor:down": MonitorEvent
        +"state-sync-event": StateSyncPayload
        +"cache-updated": CacheUpdateEvent
    ...
    class CacheUpdateEvent {
        +cacheType: "sites" | "monitors" | "history"
    ...
    UptimeEvents --> MonitorStatusEvent
    UptimeEvents --> MonitorEvent
    UptimeEvents --> StateSyncPayload
    UptimeEvents --> CacheUpdateEvent
