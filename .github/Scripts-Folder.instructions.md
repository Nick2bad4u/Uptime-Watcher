...
- Runtime and style:
  ...
  - The repository also contains a handful of PowerShell helpers (`*.ps1`) and a legacy `generate_prompts.py`; keep cross-platform behaviour in mind and only touch these when absolutely necessary, following the dedicated PowerShell guidelines.
- Safety:
