...
- The linters you need to look into are ESLint, Stylelint, and any other linters configured in the project. You can run them all with the commands "npm run lint:all" or "npm run lint:all:fix".
