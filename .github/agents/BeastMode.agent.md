...
handoffs:
 ...
 - label: Review Loop
   ...
   send: true
tools: ['execute/testFailure', 'execute/getTerminalOutput', 'execute/runTask', 'execute/createAndRunTask', 'execute/runInTerminal', 'execute/runTests', 'read/readFile', 'read/getTaskOutput', 'agent/runSubagent', 'edit/createDirectory', 'edit/createFile', 'edit/editFiles', 'search/changes', 'search/codebase', 'search/fileSearch', 'search/listDirectory', 'search/textSearch', 'search/usages', 'search/searchSubagent', 'tavily-remote-mcp/tavily_crawl', 'tavily-remote-mcp/tavily_extract', 'tavily-remote-mcp/tavily_map', 'tavily-remote-mcp/tavily_search', 'vscode-mcp/execute_command', 'vscode-mcp/get_diagnostics', 'vscode-mcp/get_references', 'vscode-mcp/get_symbol_lsp_info', 'vscode-mcp/rename_symbol', 'updateUserPreferences', 'memory', 'askQuestions', 'todo']
---
