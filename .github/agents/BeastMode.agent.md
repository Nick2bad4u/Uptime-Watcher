...
tools: ['edit/createFile', 'edit/createDirectory', 'edit/editFiles', 'search/fileSearch', 'search/textSearch', 'search/listDirectory', 'search/readFile', 'search/codebase', 'Tavily-Remote-MCP/*', 'deepwiki/*', 'vscode-mcp/execute_command', 'vscode-mcp/get_diagnostics', 'vscode-mcp/get_references', 'vscode-mcp/get_symbol_lsp_info', 'vscode-mcp/rename_symbol', 'runCommands/getTerminalOutput', 'runCommands/runInTerminal', 'runTasks/runTask', 'runTasks/getTaskOutput', 'usages', 'problems', 'changes', 'testFailure', 'fetch', 'memory', 'todos', 'runSubagent', 'runTests']
handoffs:
 - label: Consistency
   agent: BeastMode
