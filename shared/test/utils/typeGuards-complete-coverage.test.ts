...
describe("TypeGuards - Complete Function Coverage", () => {
    ...
    describe(isNumber, () => {
        it("should return true for valid numbers", async ({
            ...
            expect(isNumber(-123)).toBeTruthy();
            expect(isNumber(3.14159)).toBeTruthy();
    ...
    describe(isFiniteNumber, () => {
        it("should return true for finite numbers", async ({
            ...
            expect(isFiniteNumber(-123)).toBeTruthy();
            expect(isFiniteNumber(3.14159)).toBeTruthy();
    ...
    describe(isPositiveNumber, () => {
        it("should return true for positive numbers", async ({
            ...
            expect(isPositiveNumber(3.14159)).toBeTruthy();
    ...
    describe(isValidTimestamp, () => {
        ...
        it("should return true for valid timestamps", async ({
            ...
            expect(isValidTimestamp(mockTime)).toBeTruthy();
            expect(isValidTimestamp(mockTime - 1000)).toBeTruthy();
            expect(isValidTimestamp(mockTime + 3_600_000)).toBeTruthy(); // 1 hour in future
        ...
        it("should return true for timestamps up to 1 day in future", async ({
            ...
            expect(isValidTimestamp(mockTime + oneDayInMs)).toBeTruthy();
            expect(isValidTimestamp(mockTime + oneDayInMs - 1000)).toBeTruthy();
        });
        ...
        it("should return false for timestamps too far in future", async ({
            ...
            expect(isValidTimestamp(mockTime + oneDayInMs + 1000)).toBeFalsy();
            expect(isValidTimestamp(mockTime + 2 * oneDayInMs)).toBeFalsy();
        });
