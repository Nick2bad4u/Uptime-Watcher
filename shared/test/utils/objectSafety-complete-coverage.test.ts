...
describe("shared/utils/objectSafety.ts - Complete Function Coverage", () => {
  describe("safeObjectAccess", () => {
    it("should return property value when exists and valid", () => {
    ...
    it("should return fallback when validator fails", () => {
  ...
  describe("safeObjectIteration", () => {
    it("should iterate over object properties safely", () => {
    ...
    it("should not iterate when input is not an object", () => {
    ...
    it("should not include symbol keys (Object.entries limitation)", () => {
      const symbolKey = Symbol("test");
  ...
  describe("safeObjectOmit", () => {
    ...
    it("should return empty object when input is null/undefined", () => {
  ...
  describe("safeObjectPick", () => {
    ...
    it("should throw TypeError when input is null/undefined", () => {
      expect(() => safeObjectPick(null as any, ["key"])).toThrow(TypeError);
      expect(() => safeObjectPick(undefined as any, ["key"])).toThrow(TypeError);
    });
  ...
  describe("typedObjectEntries", () => {
    it("should return typed object entries", () => {
      const obj = { a: 1, b: 2, c: 3 };
  ...
  describe("typedObjectKeys", () => {
    ...
    it("should return keys in enumerable order", () => {
  ...
  describe("typedObjectValues", () => {
    ...
    it("should return values in enumerable order", () => {
