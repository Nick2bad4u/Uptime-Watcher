...
describe("Shared Type Helpers", () => {
    describe("castIpcResponse", () => {
        it("should cast response without validator", async ({ task, annotate }) => {
            // Add test metadata
        ...
        it("should cast response with successful validator", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
        ...
        it("should throw error with failing validator", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
    ...
    describe("isNumber", () => {
        it("should return true for valid numbers", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
        ...
        it("should return false for invalid numbers and non-numbers", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
            await annotate("Operation: Number Type Guard", "operation");
    ...
    describe("isRecord", () => {
        it("should return true for record objects", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
        ...
        it("should return false for non-record values", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
            await annotate("Operation: Record Type Guard", "operation");
    ...
    describe("isString", () => {
        ...
        it("should return false for non-strings", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
            await annotate("Operation: String Type Guard", "operation");
    ...
    describe("safePropertyAccess", () => {
        it("should return property value for existing properties", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
        ...
        it("should return undefined for non-existing properties", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
            await annotate("Operation: Safe Property Access", "operation");
    ...
    describe("validateAndConvert", () => {
        it("should return validated value for valid types", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
            await annotate("Operation: Validate and Convert", "operation");
            
            const isStringValidator = (val: unknown): val is string => typeof val === "string";
        ...
        it("should throw for invalid types", async ({ task, annotate }) => {
            ...
            const isStringValidator = (val: unknown): val is string => typeof val === "string";
            expect(() => validateAndConvert(123, isStringValidator)).toThrow("Type validation failed");
            expect(() => validateAndConvert(null, isStringValidator)).toThrow("Type validation failed");
        });

        it("should throw with custom error message", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "unit");
            await annotate("Component: Type Helpers", "component");
            await annotate("Operation: Validate and Convert", "operation");
            
            const isStringValidator = (val: unknown): val is string => typeof val === "string";
            expect(() => validateAndConvert(123, isStringValidator, "Custom error")).toThrow("Custom error");
        });
    });

    describe("Complex Type Scenarios", () => {
        it("should handle nested object validation", async ({ task, annotate }) => {
            ...
            expect(safePropertyAccess(complexObject, "user")).toEqual({ name: "test", age: 25 });
        ...
        it("should handle edge cases gracefully", async ({ task, annotate }) => {
            ...
            expect(safePropertyAccess({ hasOwnProperty: "test" }, "hasOwnProperty")).toBe("test");
        });

        it("should work with type validation chains", async ({ task, annotate }) => {
            await annotate(`Testing: ${task.name}`, "integration");
            await annotate("Component: Type Helpers", "component");
