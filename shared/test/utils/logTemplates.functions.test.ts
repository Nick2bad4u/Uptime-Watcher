...
describe("logTemplates function coverage", () => {
    ...
    describe("createTemplateLogger", () => {
        it("should create a logger with template functions", () => {
        ...
        it("should log debug messages with template interpolation", () => {
            const logger = createTemplateLogger(mockLogger);
        ...
        it("should log info messages with template interpolation", () => {
            const logger = createTemplateLogger(mockLogger);
        ...
        it("should log warning messages with template interpolation", () => {
            const logger = createTemplateLogger(mockLogger);
        ...
        it("should log error messages with template interpolation", () => {
            const logger = createTemplateLogger(mockLogger);
    ...
    describe("interpolateLogTemplate", () => {
        it("should interpolate basic placeholders", () => {
        ...
        it("should handle placeholders with dollar signs", () => {
        ...
        it("should handle complex template with many placeholders", () => {
            const template =
