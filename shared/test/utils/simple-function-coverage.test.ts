...
describe('Simple Function Coverage Tests', () => {
  describe('objectSafety functions', () => {
    ...
    test('safeObjectIteration function exists and works', () => {
      ...
      let count = 0;
      objectSafety.safeObjectIteration(testObj, () => { count++; });
      expect(count).toBe(2);
    });
  ...
  describe('validation functions', () => {
    ...
    test('getMonitorValidationErrors function exists and works', () => {
      ...
      expect(typeof validation.getMonitorValidationErrors).toBe('function');
  ...
  describe('errorCatalog functions', () => {
    test('formatErrorMessage function exists and works', () => {
      ...
      const formatted = errorCatalog.formatErrorMessage('NETWORK_TIMEOUT', {});
    ...
    test('isKnownErrorMessage function exists and works', () => {
      ...
      expect(typeof errorCatalog.isKnownErrorMessage('test')).toBe('boolean');
    });
  });
  ...
  describe('safeConversions functions', () => {
    test('safeNumberConversion function exists and works', () => {
      ...
      expect(typeof safeConversions.safeNumberConversion).toBe('function');
    ...
    test('safeParseCheckInterval function exists and works', () => {
      ...
      expect(typeof safeConversions.safeParseCheckInterval).toBe('function');
      
      expect(typeof safeConversions.safeParseCheckInterval(60000)).toBe('number');
    });
    ...
    test('safeParsePercentage function exists and works', () => {
      ...
      expect(typeof safeConversions.safeParsePercentage('50')).toBe('number');
    });
    ...
    test('safeParsePositiveInt function exists and works', () => {
      ...
      expect(typeof safeConversions.safeParsePositiveInt).toBe('function');
      
      expect(typeof safeConversions.safeParsePositiveInt('5')).toBe('number');
    });

    test('safeParseRetryAttempts function exists and works', () => {
      expect(safeConversions.safeParseRetryAttempts).toBeDefined();
      expect(typeof safeConversions.safeParseRetryAttempts).toBe('function');
      
      expect(typeof safeConversions.safeParseRetryAttempts('3')).toBe('number');
    });
    ...
    test('safeParseTimeout function exists and works', () => {
      ...
      expect(typeof safeConversions.safeParseTimeout('5000')).toBe('number');
    });
    ...
    test('safeParseTimestamp function exists and works', () => {
      ...
      expect(typeof safeConversions.safeParseTimestamp(Date.now().toString())).toBe('number');
    });
  });
  ...
  describe('typeHelpers functions', () => {
    ...
    test('validateAndConvert function exists and works', () => {
      ...
      const validator = (x: unknown): x is number => typeof x === 'number';
  ...
  describe('jsonSafety functions', () => {
    test('safeJsonParse function exists and works', () => {
      ...
      const result = jsonSafety.safeJsonParse('{"test": true}', validator);
    ...
    test('safeJsonParseWithFallback function exists and works', () => {
      ...
      expect(typeof jsonSafety.safeJsonParseWithFallback).toBe('function');
      
      const validator = (_x: unknown): _x is any => true;
      const fallback = { fallback: true };
      const result = jsonSafety.safeJsonParseWithFallback('{"test": true}', validator, fallback);
      expect(result).toBeDefined();
    });
    ...
    test('safeJsonStringifyWithFallback function exists and works', () => {
      ...
      expect(typeof jsonSafety.safeJsonStringifyWithFallback).toBe('function');
      
      const result = jsonSafety.safeJsonStringifyWithFallback({ test: true }, '{}');
      expect(typeof result).toBe('string');
    });
  });
