 ...
 * 
 * @fileoverview Function coverage validation for chartConfig type guards
 */
...
describe("Function Coverage Validation", () => {
    it("should call all exported functions to ensure 100% function coverage", () => {
        ...
        expect(Array.isArray(chartConfig.DEFAULT_CHART_THEMES.dark.backgroundColors)).toBe(true);
        expect(Array.isArray(chartConfig.DEFAULT_CHART_THEMES.dark.borderColors)).toBe(true);
        expect(Array.isArray(chartConfig.DEFAULT_CHART_THEMES.light.backgroundColors)).toBe(true);
        expect(Array.isArray(chartConfig.DEFAULT_CHART_THEMES.light.borderColors)).toBe(true);
        
        // Verify theme properties exist
        expect(chartConfig.DEFAULT_CHART_THEMES.dark.backgroundColors.length).toBeGreaterThan(0);
        expect(chartConfig.DEFAULT_CHART_THEMES.dark.borderColors.length).toBeGreaterThan(0);
        expect(chartConfig.DEFAULT_CHART_THEMES.light.backgroundColors.length).toBeGreaterThan(0);
        expect(chartConfig.DEFAULT_CHART_THEMES.light.borderColors.length).toBeGreaterThan(0);
    });
});
