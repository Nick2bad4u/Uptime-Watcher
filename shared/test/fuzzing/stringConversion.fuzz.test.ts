...
describe("StringConversion - Fast-Check Fuzzing Tests", () => {
    describe("safeStringify comprehensive fuzzing", () => {
        test.prop([fc.anything()])(
            "should handle all possible value types safely",
            (value) => {
        ...
        test.prop([fc.string()])(
            "should handle objects with overridden valueOf/toString",
            (value) => {
                const obj = {
                    valueOf: () => value,
                    toString: () => value,
        ...
        test.prop([fc.string()])(
            "should handle edge cases that might bypass typeof",
            (testValue) => {
