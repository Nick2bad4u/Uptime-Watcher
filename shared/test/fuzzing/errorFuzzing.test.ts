...
describe("ErrorHandling Fuzzing - Line 141", () => {
    ...
    test.prop([
        ...
        ), // Exclude null to avoid the "in" operator error
    ...
    describe("Error handling edge cases", () => {
        ...
        test.prop([
            fc.oneof(fc.constantFrom(null, undefined), fc.string(), fc.integer()),
            ...
            async (invalidOperationName, errorMessage) => {
                ...
                const expectedMessage = invalidOperationName ? `Failed to ${invalidOperationName}` : "Async operation failed";
