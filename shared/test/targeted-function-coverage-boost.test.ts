 ...
 *
 * This test specifically targets the 154 uncovered functions identified from
 * the coverage report to boost function coverage from 87.89% to 90%+
 */
...
describe("Targeted Function Coverage Boost - Shared Utilities", () => {
    ...
    describe("Error Handling Functions", () => {
        it("should call all error handling functions", async () => {
            ...
            expect(typeof errorHandlingModule.withErrorHandling).toBe(
                "function"
            );
            await errorHandlingModule.withErrorHandling(
                async () => "handled-success",
                {
                    logger: { error: () => {} },
    ...
    describe("JSON Safety Functions", () => {
        it("should call all JSON safety functions", async () => {
            ...
            expect(typeof jsonModule.safeJsonParseWithFallback).toBe(
                "function"
            );
            ...
            expect(typeof jsonModule.safeJsonStringifyWithFallback).toBe(
                "function"
            );
    ...
    describe("Object Safety Functions", () => {
        it("should call all object safety functions", async () => {
            const objectModule = await import(
            ...
            objectModule.safeObjectIteration(
                { a: 1, b: 2 },
                (key, value) => `${key}=${value}`
            );
    ...
    describe("Safe Conversions Functions", () => {
        it("should call all safe conversion functions", async () => {
            const conversionsModule = await import(
                "../../shared/utils/safeConversions"
            );

            // Call safeNumberConversion function
            expect(typeof conversionsModule.safeNumberConversion).toBe(
                "function"
            );
            ...
            expect(typeof conversionsModule.safeParseCheckInterval).toBe(
                "function"
            );
            ...
            expect(typeof conversionsModule.safeParsePercentage).toBe(
                "function"
            );
            ...
            expect(typeof conversionsModule.safeParseTimestamp).toBe(
                "function"
            );
            ...
            expect(typeof conversionsModule.validateAndSanitizeNumber).toBe(
                "function"
            );
            ...
            expect(typeof conversionsModule.validateAndSanitizeString).toBe(
                "function"
            );
    ...
    describe("Site Status Functions", () => {
        it("should call all site status functions", async () => {
            ...
            expect(typeof siteStatusModule.calculateSiteMonitoringStatus).toBe(
                "function"
            );
            siteStatusModule.calculateSiteMonitoringStatus(mockSite);
            siteStatusModule.calculateSiteMonitoringStatus({
                ...mockSite,
                monitors: [],
            });

            // Call calculateSiteStatus function
            expect(typeof siteStatusModule.calculateSiteStatus).toBe(
                "function"
            );
            ...
            expect(typeof siteStatusModule.getSiteDisplayStatus).toBe(
                "function"
            );
            siteStatusModule.getSiteDisplayStatus(mockSite);
            siteStatusModule.getSiteDisplayStatus({
                ...mockSite,
                monitors: [],
            });

            // Call getSiteStatusDescription function
            expect(typeof siteStatusModule.getSiteStatusDescription).toBe(
                "function"
            );
            ...
            expect(typeof siteStatusModule.getSiteStatusVariant).toBe(
                "function"
            );
    ...
    describe("String Conversion Functions", () => {
        it("should call all string conversion functions", async () => {
            const stringModule = await import(
    ...
    describe("Type Helpers Functions", () => {
        it("should call all type helper functions", async () => {
            ...
            try {
                typeHelpersModule.castIpcResponse(
                    "test",
            ...
            expect(typeof typeHelpersModule.safePropertyAccess).toBe(
                "function"
            );
            typeHelpersModule.safePropertyAccess(
                { test: "value" },
                "test",
                "default"
            );
            ...
            expect(typeof typeHelpersModule.validateAndConvert).toBe(
                "function"
            );
    ...
    describe("Validation Functions", () => {
        it("should call all validation functions", async () => {
            ...
            expect(typeof validationModule.validateMonitorType).toBe(
                "function"
            );
            ...
            expect(typeof validationModule.validateBasicMonitorFields).toBe(
                "function"
            );
            validationModule.validateBasicMonitorFields(mockMonitor);
            validationModule.validateBasicMonitorFields({
                ...mockMonitor,
                name: "",
            });

            // Call validateHttpMonitorFields function
            expect(typeof validationModule.validateHttpMonitorFields).toBe(
                "function"
            );
            validationModule.validateHttpMonitorFields(mockMonitor);
            validationModule.validateHttpMonitorFields({
                ...mockMonitor,
                url: "",
            });

            // Call validatePingMonitorFields function
            expect(typeof validationModule.validatePingMonitorFields).toBe(
                "function"
            );
            validationModule.validatePingMonitorFields({
                ...mockMonitor,
                type: "ping",
                host: "example.com",
            });
            ...
            expect(typeof validationModule.validatePortMonitorFields).toBe(
                "function"
            );
            validationModule.validatePortMonitorFields({
                ...mockMonitor,
                type: "port",
                host: "example.com",
                port: 80,
            ...
            expect(typeof validationModule.validateRequiredField).toBe(
                "function"
            );
    ...
    describe("Cache Keys Functions", () => {
        it("should call all cache key functions", async () => {
            const cacheKeysModule = await import(
    ...
    describe("Log Templates Functions", () => {
        it("should call all log template functions", async () => {
            ...
            expect(typeof logTemplatesModule.interpolateLogTemplate).toBe(
                "function"
            );
            logTemplatesModule.interpolateLogTemplate("Hello {{name}}!", {
                name: "World",
            });
            logTemplatesModule.interpolateLogTemplate("No variables", {});

            // Call createTemplateLogger function
            expect(typeof logTemplatesModule.createTemplateLogger).toBe(
                "function"
            );
            const logger =
                logTemplatesModule.createTemplateLogger("test-context");
            logger.info("Test message with {{variable}}", {
                variable: "value",
            });
...
describe("Targeted Function Coverage Boost - Type Validation", () => {
    ...
    describe("Database Type Functions", () => {
        it("should call all database type functions", async () => {
            ...
            databaseModule.safeGetRowProperty(
                { name: "test" },
                "name",
                "default"
            );
    ...
    describe("Monitor Config Type Functions", () => {
        it("should call all monitor config type functions", async () => {
            const monitorConfigModule = await import(
                "../../shared/types/monitorConfig"
            );

            // Call isHttpMonitorConfig function
            expect(typeof monitorConfigModule.isHttpMonitorConfig).toBe(
                "function"
            );
            ...
            expect(typeof monitorConfigModule.isPingMonitorConfig).toBe(
                "function"
            );
            ...
            expect(typeof monitorConfigModule.isPortMonitorConfig).toBe(
                "function"
            );
    ...
    describe("Validation Type Functions", () => {
        it("should call all validation type functions", async () => {
            ...
            expect(typeof validationModule.createFailureResult).toBe(
                "function"
            );
            ...
            expect(typeof validationModule.createSuccessResult).toBe(
                "function"
            );
...
describe("Targeted Function Coverage Boost - Validation Utils", () => {
    describe("Validator Utils Functions", () => {
        it("should call all validator utility functions", async () => {
            ...
            expect(typeof validatorModule.isValidIdentifierArray).toBe(
                "function"
            );
            ...
            expect(typeof validatorModule.isValidPositiveInteger).toBe(
                "function"
            );
    ...
    describe("Schema Validation Functions", () => {
        it("should call all schema validation functions", async () => {
            ...
            expect(typeof schemasModule.validateFieldWithSchema).toBe(
                "function"
            );
            ...
            schemasModule.validateMonitorData({
                ...validHttpMonitor,
                url: "invalid-url",
            });
