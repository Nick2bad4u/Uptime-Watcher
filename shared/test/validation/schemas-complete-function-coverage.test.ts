/**
 * Complete Function Coverage Tests for schemas.ts
...
describe('Schemas - Complete Function Coverage', () => {
    describe('Function Coverage Validation', () => {
        ...
        it('should exercise additional function paths and error conditions', () => {
            ...
            schemasModule.validateMonitorField('http', 'checkInterval', 2592000000);  // Maximum
            ...
            try {
                schemasModule.validateMonitorField('http', 'nonexistentfield', 'value');
            } catch (error) {
        ...
        it('should call validation functions with all supported monitor types', () => {
            ...
            const monitorTypes = ['http', 'port', 'ping', 'dns'];
            ...
            for (const type of monitorTypes) {
                ...
                schemasModule.validateMonitorField(type, 'checkInterval', 60000);
            ...
            schemasModule.validateMonitorField('dns', 'dnsServer', '8.8.8.8');
            schemasModule.validateMonitorField('dns', 'recordType', 'A');
            schemasModule.validateMonitorField('dns', 'expectedValue', '192.168.1.1');
