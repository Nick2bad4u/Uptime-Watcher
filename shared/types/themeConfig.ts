 ...
 *
 * @remarks
 * These interfaces provide type-safe configuration structures for application theming.
 * They ensure proper typing for colors, spacing, typography, and component styling.
 *
