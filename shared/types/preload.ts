...
interface DataChannelMap {
    ...
    readonly saveSqliteBackup: "save-sqlite-backup";
}
...
const DATA_CHANNELS_DEFINITION: DataChannelMap = {
    ...
    saveSqliteBackup: "save-sqlite-backup",
};
...
interface CloudChannelMap {
    ...
    readonly connectGoogleDrive: "cloud-connect-google-drive";
...
const CLOUD_CHANNELS_DEFINITION: CloudChannelMap = {
    ...
    connectGoogleDrive: "cloud-connect-google-drive",
