...
export const cloudSyncMonitorConfigSchema: z.ZodType<CloudSyncMonitorConfig> = z
    .object({
        ...
        certificateWarningDays: z.number().int().nonnegative().optional(),
        checkInterval: z.number().int().nonnegative(),
        ...
        expectedStatusCode: z.number().int().nonnegative().optional(),
        expectedValue: z.string().min(1).optional(),
        headerName: z.string().min(1).optional(),
        heartbeatExpectedStatus: z.string().min(1).optional(),
        heartbeatMaxDriftSeconds: z.number().int().nonnegative().optional(),
        ...
        maxPongDelayMs: z.number().int().nonnegative().optional(),
        maxReplicationLagSeconds: z.number().int().nonnegative().optional(),
