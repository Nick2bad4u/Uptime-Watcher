...
export const SERVICE_LOGS = {
    ...
    /** Migration system */
    MIGRATION_APPLYING: "Applying migration: {monitorType} {fromVersion} → {toVersion}",

    MIGRATION_REGISTERED: "Registered migration for {monitorType}: {fromVersion} → {toVersion}",
...
export const DEBUG_LOGS = {
    ...
    APPLICATION_FORWARDING_MONITOR_UP: "[ApplicationService] Monitor recovered - forwarding to renderer",
...
export const ERROR_LOGS = {
    ...
    APPLICATION_FORWARD_MONITOR_DOWN_ERROR: "[ApplicationService] Failed to forward monitor down to renderer",
    APPLICATION_FORWARD_MONITOR_STATUS_ERROR:
        "[ApplicationService] Failed to forward monitor status change to renderer",
    APPLICATION_FORWARD_MONITOR_UP_ERROR: "[ApplicationService] Failed to forward monitor up to renderer",
...
export const WARNING_LOGS = {
    ...
    APPLICATION_MONITOR_DOWN: "[ApplicationService] Monitor failure detected - forwarding to renderer",
