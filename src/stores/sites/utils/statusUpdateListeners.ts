 ...
 * {@link src/stores/sites/utils/statusUpdateHandler#StatusUpdateManager} so the
 * manager can focus on orchestration and recovery while this module focuses on
 * listener setup.
 */
