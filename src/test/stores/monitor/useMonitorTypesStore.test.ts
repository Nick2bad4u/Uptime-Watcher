...
describe('useMonitorTypesStore', () => {
  ...
  it('should load monitor types successfully', async () => {
    ...
    expect(result.current.fieldConfigs.http).toEqual([{ name: 'url', type: 'string', required: true, label: 'URL' }]);
  });
  ...
  it('should format monitor detail', async () => {
    ...
    mockElectronAPI.monitorTypes.formatMonitorDetail.mockResolvedValue(mockResponse);
  ...
  it('should format monitor title suffix', async () => {
    ...
    mockElectronAPI.monitorTypes.formatMonitorTitleSuffix.mockResolvedValue(mockResponse);
  ...
  it('should get field config', () => {
    ...
    const nonExistentConfig = result.current.getFieldConfig('nonexistent' as MonitorType);
  ...
  it('should handle errors in formatting functions', async () => {
    ...
    mockElectronAPI.monitorTypes.formatMonitorDetail.mockResolvedValue(mockErrorResponse);
