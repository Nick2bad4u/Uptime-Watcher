    ...
    describe("Type Guard Functions", () => {
        describe(isHttpFormData, () => {
            ...
            it("should return false for data with wrong type", async ({
                ...
                expect(
                    isHttpFormData(
                        safeCastTo<Partial<MonitorFormData>>(wrongType)
                    )
                ).toBeFalsy();
            });
            ...
            it("should return false for data missing URL", async ({
                ...
                expect(
                    isHttpFormData(
                        safeCastTo<Partial<MonitorFormData>>(missingUrl)
                    )
                ).toBeFalsy();
            });
        ...
        describe(isPingFormData, () => {
            ...
            it("should return false for data missing host", async ({
                ...
                expect(
                    isPingFormData(
                        safeCastTo<Partial<MonitorFormData>>(missingHost)
                    )
                ).toBeFalsy();
            });
        ...
        describe(isPortFormData, () => {
            ...
            it("should return false for data missing port", async ({
                ...
                expect(
                    isPortFormData(
                        safeCastTo<Partial<MonitorFormData>>(missingPort)
                    )
                ).toBeFalsy();
            });
