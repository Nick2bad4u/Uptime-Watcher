 ...
 * 
 * @fileoverview This module provides reusable test utilities for creating
 * valid mock objects that conform to the strict TypeScript interface requirements
 * across all test files in the project.
 */

import type { Monitor, MonitorStatus, MonitorType, StatusHistory } from '../../../shared/types';
 ...
 * ```
 */
export const createValidMonitor = (partial: Partial<Monitor> = {}): Monitor => ({
    activeOperations: [],
 ...
 */
export const createValidStatusHistory = (partial: Partial<StatusHistory> = {}): StatusHistory => ({
    timestamp: Date.now(),
    status: 'up' as const,
    responseTime: 100,
    ...partial,
