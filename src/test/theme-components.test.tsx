...
describe("Theme Components", () => {
    ...
    describe("ThemedButton", () => {
        ...
        it("should render with icon on right", () => {
            render(<ThemedButton icon={<span>📤</span>} iconPosition="right">Send</ThemedButton>);
        ...
        it("should render icon with color", () => {
            render(<ThemedButton icon={<span>⭐</span>} iconColor="primary">Star</ThemedButton>);
        ...
        it("should render icon with custom hex color", () => {
            render(<ThemedButton icon={<span>🔥</span>} iconColor="#ff5733">Fire</ThemedButton>);
    ...
    describe("ThemedBadge", () => {
        ...
        it("should render with icon and custom iconColor", () => {
            render(<ThemedBadge icon={<span>⭐</span>} iconColor="primary">Star Badge</ThemedBadge>);
  ...
  describe('Edge cases for 100% coverage', () => {
    it('should handle renderColoredIcon without color', () => {
      render(
        <ThemedBadge icon={<span>icon</span>}>
          Test
        </ThemedBadge>
      );
    ...
    it('should handle ThemedButton with icon but no children and iconColor', () => {
      render(
        <ThemedButton icon={<span data-testid="icon">icon</span>} iconColor="red" />
      );
    ...
    it('should handle ThemedButton with non-ReactElement icon and iconColor', () => {
      render(
        <ThemedButton icon="text-icon" iconColor="blue" />
      );
  ...
  describe("Theme Components Default Cases", () => {
    ...
    it('should handle ThemedProgress default size case', () => {
      ...
      const progressContainer = screen.getByRole('progressbar').parentElement?.querySelector('div[aria-hidden="true"]');
