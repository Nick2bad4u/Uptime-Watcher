    ...
    describe("withUtilityErrorHandling", () => {
        ...
        describe("Error handling with shouldThrow=true", () => {
            ...
            it("should log error before throwing when shouldThrow is true", async () => {
                ...
                await expect(
                    withUtilityErrorHandling(operation, "logging test", undefined, true)
            ...
            it("should wrap non-Error objects before throwing", async () => {
                ...
                await expect(
                    withUtilityErrorHandling(operation, "string error test", undefined, true)
        ...
        describe("Error handling without fallback values", () => {
            it("should throw error when shouldThrow=false but no fallback value provided", async () => {
                ...
                await expect(
                    withUtilityErrorHandling(operation, "no fallback test", undefined, false)
                ).rejects.toThrow("no fallback test failed and no fallback value provided");
            });
            ...
            it("should log original error before throwing fallback error", async () => {
                ...
                await expect(
                    withUtilityErrorHandling(operation, "logging original", undefined, false)
                ).rejects.toThrow("logging original failed and no fallback value provided");
        ...
        describe("Default parameter behavior", () => {
            it("should default shouldThrow to false", async () => {
                ...
                await expect(
                    withUtilityErrorHandling(operation, "default test", "fallback")
            ...
            it("should handle operations without optional parameters", async () => {
                ...
                ).rejects.toThrow("minimal test failed and no fallback value provided");
            });
        });
        ...
        describe("Edge cases", () => {
            ...
            it("should handle very long operation names", async () => {
                ...
                await expect(
                    withUtilityErrorHandling(operation, longName, undefined, false)
                ).rejects.toThrow(`${longName} failed and no fallback value provided`);
            });
