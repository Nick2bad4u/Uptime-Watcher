...
import type { FormFieldProperties, TextFieldProperties, SelectFieldProperties, RadioGroupProperties } from "../../../components/AddSiteForm/FormFields";
...
vi.mock("../../../theme/components", () => ({
  ...
  ThemedOption: vi.fn(({ children, value, ...props }) => (
    <option {...props} value={value}>{children}</option>
  )),
  ThemedButton: vi.fn(({ children, onClick, ...props }) => (
    <button {...props} onClick={onClick} data-testid="themed-button">{children}</button>
  ))
}));
