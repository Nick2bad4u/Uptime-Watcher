/**
 * @fileoverview Arithmetic mutation tests for ScreenshotThumbnail component
...
describe("ScreenshotThumbnail Arithmetic Mutations", () => {
    ...
    /**
     * Test viewport width multiplication: viewportW * 0.9
     * Line ~134: const maxImgW = Math.min(viewportW * 0.9, 900);
     */
    it("should detect viewport width multiplication mutation (viewportW * 0.9)", async () => {
        ...
        await waitFor(() => {
            ...
            const portal = document.querySelector('.site-details-thumbnail-portal-overlay');
    ...
    /**
     * Test viewport height multiplication: viewportH * 0.9
     * Line ~135: const maxImgH = Math.min(viewportH * 0.9, 700);
     */
    ...
    /**
     * Test width division: rect.width / 2
     * Line ~141: rect.left + rect.width / 2 - overlayW / 2
     */
    ...
    /**
     * Test overlay width division: overlayW / 2
     * Line ~141: rect.left + rect.width / 2 - overlayW / 2
     */
    ...
    /**
     * Test subtraction chain: rect.top - overlayH - 16
     * Line ~140: let top = rect.top - overlayH - 16;
     */
