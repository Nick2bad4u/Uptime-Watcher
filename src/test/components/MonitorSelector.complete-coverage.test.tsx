/**
 * Comprehensive test coverage for MonitorSelector component.
...
vi.mock("../../theme/components/ThemedSelect", () => ({
    default: ({ children, onChange, onClick, onMouseDown, value, className }: any) => (
        <select
            className={className}
            onChange={onChange}
            onClick={onClick}
...
describe("MonitorSelector - Complete Coverage", () => {
    ...
    describe("Monitor Option Formatting", () => {
        ...
        it("should handle mixed case monitor types", () => {
            const monitors = [
                { ...createMockMonitor("monitor-1", "http"), type: "HTTP" } as any,
            ];
    ...
    describe("Performance Optimizations", () => {
        ...
        it("should re-render when props change", () => {
            ...
            const newMonitors = [
                createMockMonitor("new-monitor", "http", { url: "https://new.com" }),
            ];
    ...
    describe("Edge Cases", () => {
        ...
        it("should handle monitors with special characters in URL", () => {
            ...
            const option = screen.getByText("HTTP: https://example.com/path?param=value&other=test");
            expect(option).toBeInTheDocument();
        });
    ...
    describe("Monitor Type Coverage", () => {
        it("should handle all supported monitor types", () => {
            const allTypes = [
                createMockMonitor("http-monitor", "http", { url: "https://test.com" }),
            ...
            expect(screen.getByText("HTTP: https://test.com")).toBeInTheDocument();
        ...
        it("should format monitor options consistently", () => {
            const monitors = [
                createMockMonitor("test-1", "http", { url: "http://localhost" }),
