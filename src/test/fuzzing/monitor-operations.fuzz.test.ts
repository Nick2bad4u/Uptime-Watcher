...
const arbitraryPartialMonitor = (): fc.Arbitrary<Partial<Monitor>> =>
    fc
        .record({
            ...
            expectedHeaderValue: fc.string(),
            expectedJsonValue: fc.string(),
            headerName: fc.string(),
            jsonPath: fc.string(),
            bodyKeyword: fc.string(),
            baselineUrl: arbitraryUrl(),
            edgeLocations: fc.string(),
            expectedStatusCode: fc.integer({ min: 100, max: 599 }),
            heartbeatExpectedStatus: fc.string(),
            heartbeatMaxDriftSeconds: fc.integer({ min: 0, max: 3600 }),
            heartbeatStatusField: fc.string(),
            heartbeatTimestampField: fc.string(),
            maxResponseTime: fc.integer({ min: 1, max: 60_000 }),
            maxPongDelayMs: fc.integer({ min: 1, max: 60_000 }),
            maxReplicationLagSeconds: fc.integer({ min: 0, max: 3600 }),
            primaryStatusUrl: arbitraryUrl(),
            replicaStatusUrl: arbitraryUrl(),
            replicationTimestampField: fc.string(),
...
> =>
    fc.record({
        ...
        expectedHeaderValue: arbitraryMixedValue(),
        expectedJsonValue: arbitraryMixedValue(),
        headerName: arbitraryMixedValue(),
        jsonPath: arbitraryMixedValue(),
        bodyKeyword: arbitraryMixedValue(),
        baselineUrl: arbitraryMixedValue(),
        edgeLocations: arbitraryMixedValue(),
        expectedStatusCode: arbitraryMixedValue(),
        heartbeatExpectedStatus: arbitraryMixedValue(),
        heartbeatMaxDriftSeconds: arbitraryMixedValue(),
        heartbeatStatusField: arbitraryMixedValue(),
        heartbeatTimestampField: arbitraryMixedValue(),
        maxResponseTime: arbitraryMixedValue(),
        maxPongDelayMs: arbitraryMixedValue(),
        maxReplicationLagSeconds: arbitraryMixedValue(),
        primaryStatusUrl: arbitraryMixedValue(),
        replicaStatusUrl: arbitraryMixedValue(),
        replicationTimestampField: arbitraryMixedValue(),
