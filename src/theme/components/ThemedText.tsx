 ...
 * integrates with the app's theme system to ensure consistent text styling
 * across the app. The component supports various semantic styling variants for
 * different contexts (primary, secondary, error, etc.).
 *
