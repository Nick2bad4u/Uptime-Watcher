...
describe("Site Analytics Performance Benchmarks", () => {
    ...
    bench(
        "Calculate downtime periods - Small dataset (100 records)",
        () => {
    ...
    bench(
        "Calculate response metrics - Small dataset (100 records)",
        () => {
    ...
    bench(
        "Calculate downtime periods - Medium dataset (1K records)",
        () => {
    ...
    bench(
        "Calculate response metrics - Medium dataset (1K records)",
        () => {
    ...
    bench(
        "Calculate response metrics - Large dataset (10K records)",
        () => {
    ...
    bench(
        "Complete analytics calculation - Large dataset (10K records)",
        () => {
