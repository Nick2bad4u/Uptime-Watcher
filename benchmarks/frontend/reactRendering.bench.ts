                    ...
                    children: [
                        {
                            type: "text",
                            props: {
                                content: `${this.props.site.responseTime}ms`,
                            },
                            children: [],
                        },
                    ],
                                    ...
                                    children: [
                                        {
                                            type: "text",
                                            props: {
                                                content: `${summary.onlineSites}/${summary.totalSites} Online`,
                                            },
                                            children: [],
                                        },
                                    ],
                                    ...
                                    children: [
                                        {
                                            type: "text",
                                            props: {
                                                content: `${summary.uptime.toFixed(1)}% Uptime`,
                                            },
                                            children: [],
                                        },
                                    ],
...
describe("React Component Rendering Performance", () => {
    ...
    bench(
        ...
        () => {
            ...
            const element = renderer.createElement(MockSiteCard, {
                site: siteData,
            });
            renderer.render(element);
        },
    ...
    bench(
        "render monitor status component",
        () => {
            renderer = new MockReactRenderer();
            const monitorData = {
                id: "monitor-1",
            ...
            const element = renderer.createElement(MockMonitorStatus, {
                monitor: monitorData,
            });
            renderer.render(element);
        },
    ...
    bench(
        "render site list with multiple items",
        () => {
            renderer = new MockReactRenderer();
    ...
    bench(
        ...
        () => {
            renderer = new MockReactRenderer();
            const element = renderer.createElement(MockLoadingSpinner, {
    ...
    bench(
        ...
        () => {
            ...
            // Initial render
            let element = renderer.createElement(MockSiteCard, {
                site: initialSite,
            });
            renderer.render(element);
            ...
            element = renderer.createElement(MockSiteCard, {
                site: updatedSite,
            });
    ...
    bench(
        ...
        () => {
            ...
            const element = renderer.createElement(
                ...
                {},
                showError
                    ? renderer.createElement(MockErrorBoundary, {
                          hasError: true,
                    ...
                    : hasData
                      ? renderer.createElement(MockSiteCard, {
                            site: {
                                id: "cond-site",
                                name: "Conditional Site",
                                status: "online",
                                responseTime: 300,
                            },
                        })
                      : renderer.createElement(MockLoadingSpinner, {
                            message: "Loading...",
                        })
            );
    ...
    bench(
        ...
        () => {
            ...
            for (let i = 0; i < 10; i++) {
                deepElement = renderer.createElement(
                    "div",
                    { className: `level-${i}` },
                    deepElement
                );
            ...
            const containerElement = renderer.createElement(
                "div",
