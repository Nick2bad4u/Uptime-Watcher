 ...
 * results. Provides consistent configuration management across the app with
 * built-in validation, caching, and business rule enforcement.
 *
...
// ValidationResult type available for internal use via direct import External consumers should import directly from shared/types/validation
...
/**
 * Manages business configuration, validation, and policy rules for the app.
 *
 * @remarks
