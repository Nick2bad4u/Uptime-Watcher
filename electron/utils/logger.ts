 ...
 * This is the primary logger for general application events, startup/shutdown,
 ...
 * Ideal for logging SQL queries, connection events, migration operations,
 ...
 * Perfect for logging health check results, monitor configuration changes,
 * and monitoring system performance metrics.
 *
 * @example
 * ```typescript
 ...
 * monitorLogger.debug('Response time recorded', { time: 245, url: 'https://example.com' });
 * monitorLogger.error('Monitor check failed', { siteId: 'abc123', error: 'timeout' });
 * ```
 *
 * @public
 */
