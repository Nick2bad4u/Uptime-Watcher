...
describe("MonitorOperationRegistry", () => {
    ...
    describe("initiateCheck", () => {
        ...
        it("should handle UUID collision by retrying", () => {
            ...
            registry.getActiveOperations().set("collision-uuid", existingOperation);
        ...
        it("should throw error after multiple failed UUID generation attempts", () => {
            ...
            registry.getActiveOperations().set("always-collision", existingOperation);
        ...
        it("should set accurate timestamps", () => {
            ...
            expect(operation!.initiatedAt.getTime()).toBeGreaterThanOrEqual(beforeTime.getTime());
            expect(operation!.initiatedAt.getTime()).toBeLessThanOrEqual(afterTime.getTime());
        });
    });
