...
describe("DynamicSchema Regex Mutations", () => {
    ...
    describe("toSnakeCase function regex patterns", () => {
        it("should convert camelCase field names to snake_case using first regex pattern", async ({
            task,
            annotate,
        }) => {
            ...
            const columnNames = fieldDefinitions.map(
        ...
        it("should convert internal uppercase letters to underscore + lowercase using second regex pattern", async ({
            task,
            annotate,
        }) => {
            await annotate(`Testing: ${task.name}`, "functional");
        ...
        it("should properly handle monitor type names with mixed case patterns", async ({
            task,
            annotate,
        }) => {
            await annotate(`Testing: ${task.name}`, "functional");
