...
describe('DataImportExportService', () => {
    ...
    describe('exportAllData', () => {
        it('should export all data successfully with correct format', async () => {
            ...
            vi.mocked(safeJsonStringifyWithFallback).mockReturnValue(JSON.stringify(mockExportedData));
        ...
        it('should include correct timestamp in export data', async () => {
            ...
            const callArgs = vi.mocked(safeJsonStringifyWithFallback).mock.calls[0][0] as any;
    ...
    describe('importDataFromJson', () => {
        ...
        it('should parse valid JSON data successfully', async () => {
            ...
            expect(safeJsonParse).toHaveBeenCalledWith(validJsonData, expect.any(Function));
        ...
        it('should handle validation failures', async () => {
            ...
            await expect(service.importDataFromJson(validJsonData)).rejects.toThrow(SiteLoadingError);
        ...
        it('should handle empty data scenario', async () => {
            ...
            const result = await service.importDataFromJson(JSON.stringify(emptyData));
    ...
    describe('persistImportedData', () => {
        ...
        it('should persist imported data successfully with transaction', async () => {
            ...
            expect(mockSiteRepository.deleteAllInternal).toHaveBeenCalledWith(mockDatabase);
            expect(mockSettingsRepository.deleteAllInternal).toHaveBeenCalledWith(mockDatabase);
            expect(mockMonitorRepository.deleteAllInternal).toHaveBeenCalledWith(mockDatabase);
            expect(mockHistoryRepository.deleteAllInternal).toHaveBeenCalledWith(mockDatabase);
            ...
            expect(mockLogger.info).toHaveBeenCalledWith(
                expect.stringContaining('Successfully imported 1 sites and 2 settings')
            );
        });
    ...
    describe('Integration Scenarios', () => {
        it('should handle complete import/export cycle', async () => {
            ...
            mockSiteRepository.exportAll.mockResolvedValue(mockExportData.sites);
            mockSettingsRepository.getAll.mockResolvedValue(mockExportData.settings);
            vi.mocked(safeJsonStringifyWithFallback).mockReturnValue(JSON.stringify(mockExportData));
