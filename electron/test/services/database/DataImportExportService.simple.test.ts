...
const mockWithDatabaseOperation = vi
    .fn()
...
describe("DataImportExportService", () => {
    ...
    describe("exportAllData", () => {
        ...
        it("should include correct timestamp in export data", async () => {
            ...
            const callArgs = mockSafeJsonStringifyWithFallback.mock
                .calls[0][0] as any;
    ...
    describe("importDataFromJson", () => {
        ...
        it("should handle validation failures", async () => {
            ...
            await expect(service.importDataFromJson("test")).rejects.toThrow(
                mockSiteLoadingError
            );
        });
    ...
    describe("persistImportedData", () => {
        ...
        it("should persist imported data successfully", async () => {
            ...
            ).toHaveBeenCalledWith(expect.anything(), sampleSettings);

            expect(mockLogger.info).toHaveBeenCalledWith(
                expect.stringContaining(
                    "Successfully imported 1 sites and 1 settings"
                )
            );
        });
