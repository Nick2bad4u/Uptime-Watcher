...
describe("NotificationService", () => {
    ...
    describe("Constructor", () => {
        it("should initialize with default configuration", async ({ task, annotate }) => {
 ...
 const service = new NotificationService();
        ...
        it("should initialize with custom configuration", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
 ...
 const customConfig: NotificationConfig = {
    ...
    describe("notifyMonitorDown", () => {
        ...
        it("should show notification when alerts are enabled", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
 ...
 notificationService.notifyMonitorDown(mockSite, "monitor-1");
        ...
        it("should not show notification when down alerts are disabled", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
 ...
 notificationService.updateConfig({ showDownAlerts: false });
        ...
        it("should handle missing monitor gracefully", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
 ...
 notificationService.notifyMonitorDown(
        ...
        it("should handle invalid monitorId gracefully", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
 ...
 notificationService.notifyMonitorDown(mockSite, "");
        ...
        it("should handle unsupported notifications gracefully", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
 ...
 notificationService.notifyMonitorUp(mockSite, "monitor-1");
        ...
        it("should not show notification when up alerts are disabled", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
 ...
 notificationService.notifyMonitorUp(
    ...
    describe("updateConfig", () => {
        it("should update partial configuration", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
 ...
 notificationService.updateConfig({ showDownAlerts: false });
        ...
        it("should update multiple configuration options", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
 ...
 notificationService.updateConfig({
    ...
    describe("getConfig", () => {
        it("should return a copy of the configuration", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
 ...
 const config1 = notificationService.getConfig();
    ...
    describe("isSupported", () => {
        it("should return true when notifications are supported", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
            
            (Notification as any).isSupported.mockReturnValue(true);
            expect(notificationService.isSupported()).toBe(true);
        });
        it("should return false when notifications are not supported", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: types", "component");
