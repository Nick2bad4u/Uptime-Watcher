...
describe("Shared Validation Utils", () => {
    describe("isNonEmptyString", () => {
        it("should return true for non-empty strings", async ({ task, annotate }) => {
            // Add test metadata
        ...
        it("should return false for empty/invalid values", async ({ task, annotate }) => {
            // Add test metadata
            await annotate(`Testing: ${task.name}`, "functional");
            await annotate("Component: Shared Validation Utils", "component");
    ...
    describe("isValidUrl", () => {
        it("should validate correct URL formats", async ({ task, annotate }) => {
            // Add test metadata
            await annotate(`Testing: ${task.name}`, "functional");
            await annotate("Component: Shared Validation Utils", "component");
        ...
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
 ...
 expect(isValidUrl("not-a-url")).toBe(false);
    ...
    describe("isValidFQDN", () => {
        it("should validate correct FQDN formats", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
 ...
 expect(isValidFQDN("")).toBe(false);
        ...
        it("should handle localhost based on options", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
    ...
    describe("isValidIdentifier", () => {
        it("should validate correct identifier formats", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
 ...
 expect(isValidIdentifier("test")).toBe(true);
        ...
        it("should reject invalid identifier formats", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
 ...
 expect(safeInteger("123", 0)).toBe(123);
        ...
        it("should return default for invalid values", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
 ...
 expect(safeInteger(Number.NaN, 1)).toBe(1);
    ...
    describe("Integration tests", () => {
        it("should work together for complex validation scenarios", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
        ...
        it("should provide consistent validation behavior", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
 ...
 expect(isValidInteger("123.45")).toBe(false);
        ...
        it("should respect bounds when provided", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
 ...
 expect(isValidInteger("150", { min: 100, max: 200 })).toBe(true);
    ...
    describe("isValidNumeric", () => {
        it("should validate numeric strings including decimals", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
 ...
 expect(isValidNumeric("abc")).toBe(false);
    ...
    describe("isValidIdentifierArray", () => {
        it("should validate arrays of valid identifiers", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
 ...
 expect(isValidIdentifierArray(["test", "", "invalid"])).toBe(false);
    ...
    describe("Comprehensive validation scenarios", () => {
        it("should handle complex validation workflows", async ({ task, annotate }) => {
        await annotate(`Testing: ${task.name}`, "functional"); await annotate("Component: Shared Validation Utils", "component");
