...
describe("Logger Utilities", () => {
    ...
    describe("Main Logger", () => {
        ...
        it("should handle error objects properly", async () => {
            ...
            expect(mockLog.error).toHaveBeenCalledWith(
                ...
                { message: "Test error", stack: "Error stack trace" }
            );
        });
    ...
    describe("Database Logger", () => {
        ...
        it("should handle database errors", async () => {
            ...
            expect(mockLog.error).toHaveBeenCalledWith(
                ...
                { message: "Connection timeout", stack: expect.any(String) }
            );
        });
    ...
    describe("Monitor Logger", () => {
        ...
        it("should handle monitor errors", async () => {
            ...
            expect(mockLog.error).toHaveBeenCalledWith(
                ...
                { message: "HTTP request failed", stack: expect.any(String) }
            );
        });
        ...
        it("should handle monitor warnings", async () => {
            ...
            expect(mockLog.warn).toHaveBeenCalledWith(
                "[MONITOR] Slow response time detected",
                { responseTime: 5000 }
            );
        });
    });
    ...
    describe("Logger Integration", () => {
        ...
        it("should handle edge cases gracefully", async () => {
            ...
            expect(mockLog.error).toHaveBeenCalledWith(
                "[MONITOR] Error without stack",
                { message: "No stack", stack: undefined }
            );
        });
    });
