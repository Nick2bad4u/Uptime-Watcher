 ...
 *
 * @param value - The date value to convert (Date object, string, null, or undefined)
 * @returns ISO string representation for valid dates, null for invalid/empty values
 *
 * @remarks
