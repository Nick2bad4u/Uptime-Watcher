 ...
 * @remarks Delegates to the canonical configuration located under
 *          `storybook/test-runner-jest.config.js` so the runner behaves the
 *          same regardless of the working directory that invokes it.
 */
