...
// import * as helpers from "../../../shared/utils/typeHelpers";
    ...
    describe("Type guards", () => {
        fcTest.prop([fc.anything()])(
            ...
            (input) => {
                ...
                expect(() => guards.isBoolean(input)).not.toThrow();
                expect(() => guards.isObject(input)).not.toThrow();
                expect(() => guards.isArray(input)).not.toThrow();
                expect(() => guards.isFunction(input)).not.toThrow();
            }
        );
        ...
        fcTest.prop([fc.string()])(
            ...
            (str) => {
                expect(guards.isString(str)).toBeTruthy();
                expect(guards.isNumber(str)).toBeFalsy();
                expect(guards.isBoolean(str)).toBeFalsy();
            }
        );
        ...
        fcTest.prop([fc.float()])(
            ...
            (num) => {
                expect(guards.isNumber(num)).toBeTruthy();
                expect(guards.isString(num)).toBeFalsy();
                expect(guards.isBoolean(num)).toBeFalsy();
            }
        );
        ...
        fcTest.prop([fc.boolean()])(
            ...
            (bool) => {
                expect(guards.isBoolean(bool)).toBeTruthy();
                expect(guards.isString(bool)).toBeFalsy();
                expect(guards.isNumber(bool)).toBeFalsy();
            }
        );
    });
    ...
    describe("Integration fuzzing tests", () => {
        fcTest.prop([
            ...
            if (urlValid && methodValid && timeoutValid) {
                ...
                expect(
                    objectSafety.hasProperty(deserialized, "url")
                ).toBeTruthy();
            }
        });
