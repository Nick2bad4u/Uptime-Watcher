// eslint-disable-next-line @typescript-eslint/no-require-imports, import-x/no-commonjs, import-x/unambiguous, n/no-unpublished-require, sonarjs/no-require-or-define, unicorn/prefer-module -- Storybook test runner loads CommonJS config files
