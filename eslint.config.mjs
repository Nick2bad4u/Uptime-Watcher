...
importX.flatConfigs.typescript, progress.configs.recommended, noBarrelFiles.flat, // @ts-expect-error: nitpick.configs.recommended may not have correct types, but runtime usage is verified and safe
nitpick.configs.recommended, pluginComments.recommended, // ═══════════════════════════════════════════════════════════════════════════════
